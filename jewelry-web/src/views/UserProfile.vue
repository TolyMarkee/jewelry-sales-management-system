  ...
  <div class="max-w-2xl mx-auto space-y-6">
    ...
    <div class="rounded-2xl p-6 flex items-center gap-6" style="background:var(--surface); border:1px solid var(--border)">
      ...
      <div>
        ...
        <button @click="saveProfile" :disabled="saving" class="mt-2 px-3 py-1 rounded-lg text-xs font-medium transition-all hover:scale-105" style="background:rgba(168,85,247,0.12); color:var(--accent)">
          {{ saving?'保存中...':'更新头像' }}
        </button>
      </div>
    </div>
